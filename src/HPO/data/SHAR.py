...
class SHAR(Dataset):
  ...
  def __init__(self, augmentation = None, cuda_device = 0,**kwargs):
    ...
    PATH_x = "/home/cmackinnon/scripts/datasets/SHAR/train/data.npy"#UCI HAR Dataset/train/Inertial Signals"
    PATH_y = "/home/cmackinnon/scripts/datasets/SHAR/train/labels.npy"
    PATH_group = "/home/cmackinnon/scripts/datasets/SHAR/train/groups.npy"
